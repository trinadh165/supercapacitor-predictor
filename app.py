...
# The rest of the app UI is unchanged.
# ... (all the tab, sidebar, and prediction logic is the same)
...
with tab3:
    ...
    # Re-using the generation logic for display
    # (Code here is simplified but functionally similar to the training part)
    # ...
    # This section remains the same, displaying the large training set
    # We will just show the first 1000 rows for performance
    st.dataframe(df_large.head(1000))
